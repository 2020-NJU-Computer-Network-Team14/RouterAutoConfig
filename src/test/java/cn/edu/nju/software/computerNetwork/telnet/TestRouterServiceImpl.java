...
public class TestRouterServiceImpl {
    ...
    // @Test
    // public void test() {
    // String code = routerServiceImpl.connect("RTA", "192.168.10.3", 23, "", "CISCO");
    // testSuccess(code);
    ...
    // login();
    // String code = routerServiceImpl.configInterface("RTA", "s0/0/0", "192.168.8.3", "255.255.255.0");
    // testSuccess(code);
    // code = routerServiceImpl.configInterface("RTB", "s0/0/0", "192.168.8.4", "255.255.255.0");
    // testSuccess(code);
    // code = routerServiceImpl.configInterface("RTB", "s0/0/1", "192.168.9.4", "255.255.255.0");
    // testSuccess(code);
    // code = routerServiceImpl.configInterface("RTC", "s0/0/1", "192.168.9.3", "255.255.255.0");
    // testSuccess(code);
    // }
    ...
    // login();
    // String code = routerServiceImpl.configStaticRouting("RTA", "192.168.9.0", "255.255.255.0", "192.168.8.4");
    // testSuccess(code);
    // code = routerServiceImpl.configStaticRouting("RTC", "192.168.8.0", "255.255.255.0", "192.168.9.4");
    // testSuccess(code);
    // }
    ...
    // login();
    // String code = routerServiceImpl.configCreateAccessListStandard("RTB", "10", "deny", "192.168.8.0", "0.0.0.255");
    // testSuccess(code);
    // code = routerServiceImpl.configCreateAccessListStandard("RTB", "10", "permit", "any", null);
    // testSuccess(code);
    // code = routerServiceImpl.configApplyAccessList("RTB", "s0/0/1", "10", "out");
    // testSuccess(code);
    // }
    ...
    // login();
    // String code = routerServiceImpl.configCancelAccessList("RTB", "s0/0/1", "10", "out");
    // testSuccess(code);
    // }
    ...
    // login();
    // String code = routerServiceImpl.configApplyAccessList("RTB", "s0/0/0", "10", "in");
    // testSuccess(code);
    // }
    ...
    // Assert.assertEquals("Not accessible", code);
    //
    // code = routerServiceImpl.configCancelAccessList("RTB", "s0/0/0", "10", "in");
    // testSuccess(code);
    // }
